...
const Assistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { role: 'model', text: 'Welcome to Smart. I am here to help you understand how we are rebuilding title infrastructure for the modern age. How may I assist you?', timestamp: Date.now() }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, aiMsg]);
        ...
        // Error is handled gracefully in the service
    } finally {
      setIsThinking(false);
    }
  };
